...
public class CommandExampleActivity extends AppCompatActivity implements View.OnClickListener {
  ...
  private void runCommand() {
    ...
    if (!isStoragePermissionGranted()) {
      Toast.makeText(
              CommandExampleActivity.this, "grant storage permission and retry", Toast.LENGTH_LONG)
          .show();
      return;
    }
        ...
        Observable.fromCallable(() -> YoutubeDL.getInstance().execute(request, processId, callback))
            ...
            .subscribe(
                youtubeDLResponse -> {
                  ...
                  Toast.makeText(
                          CommandExampleActivity.this, "command successful", Toast.LENGTH_LONG)
                      .show();
                  running = false;
                },
                e -> {
                  ...
                  Toast.makeText(CommandExampleActivity.this, "command failed", Toast.LENGTH_LONG)
                      .show();
                  running = false;
                });
