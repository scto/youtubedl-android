...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
      ...
      case R.id.btn_update:
        {
          AlertDialog dialog =
              new AlertDialog.Builder(this)
                  ...
                  .setItems(
                      new String[] {"Stable Releases", "Nightly Releases", "Master Releases"},
  ...
  private void updateYoutubeDL(YoutubeDL.UpdateChannel updateChannel) {
    ...
    Disposable disposable =
        Observable.fromCallable(() -> YoutubeDL.getInstance().updateYoutubeDL(this, updateChannel))
                ...
                status -> {
                  ...
                  switch (status) {
                    case DONE:
                      Toast.makeText(
                              MainActivity.this,
                              "Update successful " + YoutubeDL.getInstance().versionName(this),
                              Toast.LENGTH_LONG)
                          .show();
                      break;
                    case ALREADY_UP_TO_DATE:
                      Toast.makeText(
                              MainActivity.this,
                              "Already up to date " + YoutubeDL.getInstance().versionName(this),
                              Toast.LENGTH_LONG)
                          .show();
                      break;
                    default:
                      Toast.makeText(MainActivity.this, status.toString(), Toast.LENGTH_LONG)
                          .show();
                      break;
                  }
                  updating = false;
